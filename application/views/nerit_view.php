...
<div class="page-content">
	...
	<div class="row">
		...
		<h3
			class="header smaller lighter yellow"><strong>Cadastramento de Novo Pokemon:</strong> 
		...
		<form class="form-horizontal" action="" method="post" id="tabprof"> 
			<fieldset> 
				...
				<!-- Define campo Telefone -->
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Telefone:<b class="red"> *</b></label>
					<div class="col-sm-9">
						<input type="text" id="form-field-1" name ="telefone" value="" placeholder="Digite o nº " class="cel col-xs-10 col-sm-2"/>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Endereço <b class="red"> * </b> </label>
					<div class="col-sm-9">
						<input type="text" id="form-field-1" name ="endereco" value="" placeholder="Digite o endereço" maxlength="90" class="col-xs-10 col-sm-11" />
					</div>
				</div>

				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Escolha um tipo de pokemon   </br></label>
		...
		<!-- Define botão de cadastramento na tabela -->
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						<input type="submit" class="btn btn-primary" value="Finalizar" name="finalizar">
